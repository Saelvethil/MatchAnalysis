...
namespace Service.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        {
            var result = UserRepository.RemoveUser(userId);
            if(!result)
        ...
        [Route("User")]
        [HttpPut]
        public IHttpActionResult UpdateUser(UserWithRole u)
        {
            var userId = u.UserId;
            var roleName = u.RoleName;
            var result = UserRepository.UpdateUser(userId, roleName);
            if (!result)
